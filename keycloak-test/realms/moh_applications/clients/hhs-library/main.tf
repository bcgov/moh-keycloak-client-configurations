resource "keycloak_saml_client" "CLIENT" {
  ...
  valid_redirect_uris = [
    "https://login.ezproxy-test.hlth.gov.bc.ca/Shibboleth.sso/SAML2/Artifact",
    "https://login.ezproxy-test.hlth.gov.bc.ca/*",
    "https://login.ezproxy-test.hlth.gov.bc.ca/Shibboleth.sso/SAML2/POST*"
  ]
  base_url = "https://login.ezproxy-test.hlth.gov.bc.ca"

  idp_initiated_sso_url_name          = "ezproxy"
  assertion_consumer_post_url         = "https://login.ezproxy-test.hlth.gov.bc.ca/Shibboleth.sso/SAML2/POST"
  logout_service_post_binding_url     = "https://login.ezproxy-test.hlth.gov.bc.ca/Shibboleth.sso/SAML2/SLO/POST"
  logout_service_redirect_binding_url = "https://login.ezproxy-test.hlth.gov.bc.ca/Shibboleth.sso/SAML2/SLO/Redirect"
}
