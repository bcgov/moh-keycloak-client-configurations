...
module "scope-mappings" {
  ...
  client_id = keycloak_openid_client.CLIENT.id
  roles = {
    "MSPDIRECT-SERVICE-UAT/AUDITUSER"          = var.MSPDIRECT-SERVICE-UAT.ROLES["AUDITUSER"].id,
    ...
    "MSPDIRECT-SERVICE-UAT/HELPDESK"           = var.MSPDIRECT-SERVICE-UAT.ROLES["HELPDESK"].id,
    ...
    "MSPDIRECT-SERVICE-UAT/SOCIALSECTOR"       = var.MSPDIRECT-SERVICE-UAT.ROLES["SOCIALSECTOR"].id,
