resource "keycloak_openid_client" "CLIENT" {
  ...
  description                         = "Longitudinal Record Access. Test Environment. LRA is a FHIR Server to access Longitudinal Health Records. Client used to connect to LRA Authorization Server. Referenced as DHT-Keycloak in Prod."
