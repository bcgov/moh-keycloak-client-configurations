...
module "scope-mappings" {
  ...
  roles = {
    ...
    "USER-MANAGEMENT-SERVICE/view-client-florizel-training"         = var.USER-MANAGEMENT-SERVICE.ROLES["view-client-training"].id,
    ...
    "USER-MANAGEMENT-SERVICE/view-client-phlat_stg-web"             = var.USER-MANAGEMENT-SERVICE.ROLES["view-client-phlat_stg-web"].id,
