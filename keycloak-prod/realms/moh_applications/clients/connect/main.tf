resource "keycloak_openid_client" "CLIENT" {
  ...
  base_url                            = "https://connect.health.gov.bc.ca/"
  ...
  valid_redirect_uris = [
    "https://connect-d7.health.gov.bc.ca/*",
    "https://connect.health.gov.bc.ca/*",
    "https://dmz-1.connect-d7.health.gov.bc.ca/*",
    "https://dmz-2.connect-d7.health.gov.bc.ca/*",
    "https://dmz-1.connect.health.gov.bc.ca/*",
    "https://dmz-2.connect.health.gov.bc.ca/*"
  ]
  web_origins = [
  ]
}
