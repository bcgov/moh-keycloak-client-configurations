...
resource "keycloak_openid_audience_protocol_mapper" "Audience-Mapper" {
  add_to_id_token          = false
  client_id                = keycloak_openid_client.CLIENT.id
  included_custom_audience = "hcim"
  name                     = "Audience Mapper"
  realm_id                 = keycloak_openid_client.CLIENT.realm_id
}
resource "keycloak_openid_hardcoded_claim_protocol_mapper" "HCIM-Organization" {
