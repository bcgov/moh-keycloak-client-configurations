...
module "scope-mappings" {
  ...
  roles = {
    ...
    "USER-MANAGEMENT-SERVICE/read-only-client-umc-e2e-tests"             = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-umc-e2e-tests"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-bcer-cp"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-bcer-cp"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-dmft-webappp"              = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-dmft-webapp"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-emcod"                     = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-emcod"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-hcimweb"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-hcimweb"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-hcimweb_hd2"               = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-hcimweb_hd2"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-licence-status"            = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-licence-status"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-maid"                      = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-maid"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-mspdirect-service"         = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-mspdirect-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-pho-rsc"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-pho-rsc"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-pho-rsc-groups"            = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-pho-rsc-groups"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-pidp-service"              = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-pidp-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-plr"                       = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-plr"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-prp-service"               = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-prp-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-prime-application-local"   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-prime-application-local"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-prime-application-test"    = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-prime-application-test"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-sa-dbaac-portal"           = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-sa-dbaac-portal"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-sa-hibc-service-bc-portal" = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-sa-hibc-service-bc-portal"].id,
    "USER-MANAGEMENT-SERVICE/read-only-client-sa-sfdc"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-client-sa-sfdc"].id,
  }
}
