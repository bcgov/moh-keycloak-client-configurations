...
module "scope-mappings" {
  ...
  roles = {
    ...
    "USER-MANAGEMENT-SERVICE/read-only-bcer-cp"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-bcer-cp"].id,
    "USER-MANAGEMENT-SERVICE/read-only-dmft-webappp"              = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-dmft-webapp"].id,
    "USER-MANAGEMENT-SERVICE/read-only-emcod"                     = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-emcod"].id,
    "USER-MANAGEMENT-SERVICE/read-only-hcimweb"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-hcimweb"].id,
    "USER-MANAGEMENT-SERVICE/read-only-hcimweb_hd2"               = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-hcimweb_hd2"].id,
    "USER-MANAGEMENT-SERVICE/read-only-licence-status"            = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-licence-status"].id,
    "USER-MANAGEMENT-SERVICE/read-only-maid"                      = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-maid"].id,
    "USER-MANAGEMENT-SERVICE/read-only-mspdirect-service"         = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-mspdirect-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-pho-rsc"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-pho-rsc"].id,
    "USER-MANAGEMENT-SERVICE/read-only-pho-rsc-groups"            = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-pho-rsc-groups"].id,
    "USER-MANAGEMENT-SERVICE/read-only-pidp-service"              = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-pidp-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-plr"                       = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-plr"].id,
    "USER-MANAGEMENT-SERVICE/read-only-prp-service"               = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-prp-service"].id,
    "USER-MANAGEMENT-SERVICE/read-only-prime-application-local"   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-prime-application-local"].id,
    "USER-MANAGEMENT-SERVICE/read-only-prime-application-test"    = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-prime-application-test"].id,
    "USER-MANAGEMENT-SERVICE/read-only-sa-dbaac-portal"           = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-sa-dbaac-portal"].id,
    "USER-MANAGEMENT-SERVICE/read-only-sa-hibc-service-bc-portal" = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-sa-hibc-service-bc-portal"].id,
    "USER-MANAGEMENT-SERVICE/read-only-sa-sfdc"                   = var.USER-MANAGEMENT-SERVICE.ROLES["read-only-sa-sfdc"].id,
  }
}
